...
<thead><tr><th>NIP</th><th>Nama</th><th>Gender</th><th>WA</th><th>Email</th><th></th></tr></thead>
<tbody data-testid="teachers-list">
<?php foreach($teachers as $t): ?>
<tr><td><?= e($t['nip']) ?></td><td><?= e($t['name']) ?></td><td><?= $t['gender']=='L'?'L':'P' ?></td><td><?= e($t['whatsapp']) ?></td><td><?= e($t['email']) ?></td>
...
<script>
function editTeacher(t){ document.getElementById('t-id').value=t.id; document.getElementById('t-nip').value=t.nip||''; document.getElementById('t-name').value=t.name||''; document.getElementById('t-gender').value=t.gender||'L'; document.getElementById('t-phone').value=t.phone||''; document.getElementById('t-wa').value=t.whatsapp||''; document.getElementById('t-email').value=t.email||''; document.getElementById('t-addr').value=t.address||''; new bootstrap.Modal(document.getElementById('teacher-modal')).show(); }
</script>
